...
[NOTE]
--
You can find the example application above under link:de.tototec.cmdoption/src/test/java/de/tototec/cmdopton/TranslationTutorialMain.java[TranslationTutorialMain.java].
