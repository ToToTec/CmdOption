...
_Please note, that this page documents features possibly not yet released._
...
* to overcome some platform specific limits regarding the maximal lenght of the commandline
...
* Usage formatter now, by default, tries to detect the line lenght of the
