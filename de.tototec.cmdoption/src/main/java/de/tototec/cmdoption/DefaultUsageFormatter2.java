...
public class DefaultUsageFormatter2 implements UsageFormatter2 {
	...
	protected void formatOptions(final PrintStream output, final List<OptionHandle> options, final String title,
			final ResourceBundle resourceBundle) {
	...
	protected void formatCommands(final PrintStream output, final List<CommandHandle> commands, final String title,
			final ResourceBundle resourceBundle) {
	...
	public static void formatTable(final PrintStream output, final List<String[]> twoColData, final int prefix,
